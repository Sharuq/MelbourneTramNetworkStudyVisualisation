...
####
write.csv(AMfinal_survey_data, file = "AMfinal_survey_data.csv")
write.csv(PMfinal_survey_data, file = "PMfinal_survey_data.csv")
write.csv(weekdayAM, file = "weekdayAM.csv")
write.csv(sundayAM, file = "sundayAM.csv")
write.csv(saturdayAM, file = "saturdayAM.csv")
write.csv(weekdayPM, file = "weekdayPM.csv")
write.csv(sundayPM, file = "sundayPM.csv")
write.csv(saturdayPM, file = "saturdayPM.csv")
write.csv(routes_shapes, file = "routes_shapes.csv")